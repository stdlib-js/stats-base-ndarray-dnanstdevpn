...
> Calculate the [standard deviation][standard-deviation] of a one-dimensional double-precision floating-point ndarray, ignoring `NaN` values and using a two-pass algorithm.
...
```javascript
dnanstdevpn = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-ndarray-dnanstdevpn@umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var dnanstdevpn = require( 'path/to/vendor/umd/stats-base-ndarray-dnanstdevpn/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-ndarray-dnanstdevpn@umd/browser.js"></script>
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/stats-base-ndarray-dnanstdevpn.svg
[npm-url]: https://npmjs.org/package/@stdlib/stats-base-ndarray-dnanstdevpn

[test-image]: https://github.com/stdlib-js/stats-base-ndarray-dnanstdevpn/actions/workflows/test.yml/badge.svg?branch=main
[test-url]: https://github.com/stdlib-js/stats-base-ndarray-dnanstdevpn/actions/workflows/test.yml?query=branch:main

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/stats-base-ndarray-dnanstdevpn/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/stats-base-ndarray-dnanstdevpn?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/stats-base-ndarray-dnanstdevpn.svg
[dependencies-url]: https://david-dm.org/stdlib-js/stats-base-ndarray-dnanstdevpn/main
...
[deno-url]: https://github.com/stdlib-js/stats-base-ndarray-dnanstdevpn/tree/deno
[deno-readme]: https://github.com/stdlib-js/stats-base-ndarray-dnanstdevpn/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/stats-base-ndarray-dnanstdevpn/tree/umd
[umd-readme]: https://github.com/stdlib-js/stats-base-ndarray-dnanstdevpn/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/stats-base-ndarray-dnanstdevpn/tree/esm
[esm-readme]: https://github.com/stdlib-js/stats-base-ndarray-dnanstdevpn/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/stats-base-ndarray-dnanstdevpn/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/stats-base-ndarray-dnanstdevpn/main/LICENSE
